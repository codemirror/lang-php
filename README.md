**This repository has moved to https://code.haverbeke.berlin/codemirror/lang-php**
...
[ [**WEBSITE**](https://codemirror.net/) | [**ISSUES**](https://code.haverbeke.berlin/codemirror/dev/issues) | [**FORUM**](https://discuss.codemirror.net/) | [**CHANGELOG**](https://code.haverbeke.berlin/codemirror/lang-php/src/branch/main/CHANGELOG.md) ]
...
[MIT license](https://code.haverbeke.berlin/codemirror/lang-php/tree/main/LICENSE).
...
<dd><p>A language provider based on the <a href="https://code.haverbeke.berlin/lezer/php">Lezer PHP
